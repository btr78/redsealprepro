...
const QUESTIONS_433A = [
  ...
  { id:1,cat:"A",q:"What is required when working from heights?",opts:["Fall arrest equipment","Hard hat","Safety glasses","Steel-toed boots"],ans:0,exp:"Fall arrest equipment is mandatory for heights to prevent falls — the #1 cause of workplace fatalities in trades.",type:"recall"},
  { id:2,cat:"A",q:"Before performing maintenance on a machine, what must be done first?",opts:["Notify supervisor","Put on safety glasses","Read service manual","Apply lockout/tagout procedures"],ans:3,exp:"LOTO isolates all energy sources (electrical, pneumatic, hydraulic, mechanical, gravity) to prevent accidental startup. Legally required under OHSA.",type:"procedure"},
  { id:3,cat:"A",q:"What does WHMIS stand for?",opts:["Workplace Hazard Management and Inspection System","Worker Health and Material Inventory Standards","Workplace Hazardous Materials Information System","Workplace Hazard Monitoring and Inspection Services"],ans:2,exp:"WHMIS — Workplace Hazardous Materials Information System — is Canada's national hazard communication standard.",type:"recall"},
  { id:4,cat:"A",q:"A GHS pictogram showing a flame over a circle indicates what hazard?",opts:["Flammable","Explosive","Compressed gas","Oxidizer"],ans:3,exp:"Flame-over-circle = oxidizer. Simple flame = flammable. Exploding bomb = explosive. Gas cylinder = compressed gas.",type:"recall"},
  { id:5,cat:"A",q:"Which instrument measures bore inside diameter to 0.001\" accuracy?",opts:["Outside micrometer","Vernier caliper","Telescoping gauge and micrometer","Steel rule and divider"],ans:2,exp:"Telescoping gauge inserted into the bore, locked, then measured with an outside micrometer for 0.001\" precision.",type:"procedure"},
  { id:6,cat:"A",q:"What type of file is used for finishing soft metals like aluminum?",opts:["Double-cut bastard","Rasp-cut file","Single-cut smooth file","Double-cut second-cut"],ans:2,exp:"Single-cut smooth files produce a finer finish on soft metals and resist loading (clogging) better than double-cut.",type:"recall"},
  ...
  { id:8,cat:"A",q:"A torque wrench reads 50 ft-lbs. What is this in Newton-meters?",opts:["36.9 N·m","50 N·m","73.7 N·m","67.8 N·m"],ans:3,exp:"1 ft-lb = 1.3558 N·m → 50 × 1.3558 = 67.79 ≈ 67.8 N·m. Unit conversion is critical for metric/imperial specs.",type:"critical"},
  { id:9,cat:"A",q:"On a blueprint, what does a hidden line (dashed) represent?",opts:["An edge not visible in current view","Center of a feature","A cutting plane","A dimension extension"],ans:0,exp:"Hidden lines (short dashes) show edges that exist but aren't visible from the current viewing angle.",type:"recall"},
  ...
  { id:11,cat:"A",q:"When lighting an oxy-acetylene torch, which gas is turned on first?",opts:["Oxygen","Either one","Acetylene","Both simultaneously"],ans:2,exp:"Acetylene always first on, oxygen added to adjust flame. Shutdown: close oxygen first, then acetylene.",type:"procedure"},
  { id:12,cat:"A",q:"What type of fit allows hand assembly with slight clearance?",opts:["Interference fit","Transition fit","Shrink fit","Sliding fit (clearance fit)"],ans:3,exp:"Sliding/clearance fit: shaft slightly smaller than hole. Interference fits require force; shrink fits use heat.",type:"recall"},
  { id:13,cat:"A",q:"A metric bolt marked 8.8 — what does the first '8' indicate?",opts:["Yield strength class","Thread pitch","Ultimate tensile strength ~800 MPa","Rockwell C hardness"],ans:2,exp:"Grade 8.8: first number × 100 = UTS (800 MPa). Second × first × 100 = yield (640 MPa).",type:"recall"},
  ...
  { id:15,cat:"A",q:"What is the correct procedure for tapping a hole in mild steel?",opts:["Drill tap-drill size, chamfer, tap with cutting fluid","Drill, ream, then tap","Drill, countersink, then tap","Drill oversize, force tap"],ans:0,exp:"Drill correct tap-drill size → chamfer entrance → tap with cutting fluid for lubrication and chip clearing.",type:"procedure"},
  ...
  { id:17,cat:"A",q:"A complete maintenance report should include:",opts:["Work done, parts used, time, and recommendations","Only parts replaced","Only time spent","Symptoms only"],ans:0,exp:"Document: work performed, parts consumed, labor time, root cause, and recommendations for prevention.",type:"recall"},
  { id:18,cat:"A",q:"When is it appropriate to deviate from manufacturer's procedures?",opts:["When you have more experience","When supervisor says OK verbally","When old procedure worked before","Never without engineering approval and documentation"],ans:3,exp:"Changes require proper engineering review, approval, and documentation. Unauthorized changes void warranties and create hazards.",type:"procedure"},
  ...
  { id:21,cat:"A",q:"What layout tool scribes circles and arcs on metal?",opts:["Divider or trammel","Prick punch","Center punch","Scriber"],ans:0,exp:"Dividers for small radii, trammels for large radii — both scribe accurate circles on metal workpieces.",type:"recall"},
  { id:22,cat:"A",q:"A dial bore gauge primarily measures:",opts:["Outside diameters","Shaft runout","Internal bore diameters and taper","Surface finish"],ans:2,exp:"Dial bore gauges measure bore IDs with high precision and detect taper, out-of-round, and bell-mouth conditions.",type:"recall"},
  ...
  { id:24,cat:"A",q:"Welding electrode E7018 — what does '8' mean?",opts:["High-cellulose potassium","Rutile dioxide","Low-hydrogen iron powder coating","High iron oxide"],ans:2,exp:"E7018: E=electrode, 70=70ksi tensile, 1=all positions, 8=low-hydrogen iron powder. Preferred for structural work.",type:"recall"},
  { id:25,cat:"A",q:"For oxy-fuel cutting 1\" mild steel, which flame type?",opts:["Carburizing","Oxidizing","Reducing","Neutral flame"],ans:3,exp:"Neutral flame (equal O₂ and acetylene) preheats to cherry red, then the cutting oxygen jet oxidizes and blows molten metal.",type:"procedure"},
  ...
  { id:27,cat:"B",q:"10,000 lb load, 2-leg sling at 60° from horizontal. Load per leg?",opts:["5,000 lbs","7,071 lbs","5,774 lbs","10,000 lbs"],ans:2,exp:"At 60° from horizontal (30° from vertical): (10,000 ÷ 2) ÷ cos(30°) = 5000 ÷ 0.866 = 5,774 lbs.",type:"critical"},
  { id:28,cat:"B",q:"WLL of 1/2\" diameter 6×19 wire rope?",opts:["1 ton","4 tons","8 tons","2 tons"],ans:3,exp:"WLL = d² × 8 = (0.5)² × 8 = 2 tons. This formula is provided on the Red Seal exam.",type:"critical"},
  { id:29,cat:"B",q:"Wire rope clips required for 3/4\" diameter rope?",opts:["4","3","5","6"],ans:0,exp:"For 3/4\" rope: 4 clips required. Always follow applicable CSA/ASME standards for clip count.",type:"critical"},
  ...
  { id:31,cat:"B",q:"What does a 'critical lift' plan require?",opts:["Verbal agreement","Only crane cert","Written plan reviewed by competent person","Supervisor verbal OK"],ans:2,exp:"Critical lifts: formal written plan with load weight, crane capacity at radius, rigging, ground conditions, weather — reviewed by competent person.",type:"procedure"},
  ...
  { id:35,cat:"B",q:"As crane radius increases, what happens to capacity?",opts:["Decreases","Increases","Stays same","Doubles"],ans:0,exp:"Capacity decreases with increased radius due to greater tipping moment. Always check load chart at actual working radius.",type:"recall"},
  ...
  { id:37,cat:"B",q:"Synthetic sling has visible cuts through 10% of width. Action?",opts:["Reduce load 10%","Wrap with tape","Continue if under 25% damage","Remove from service and destroy"],ans:3,exp:"Any visible damage → immediately remove and destroy to prevent reuse. No acceptable damage threshold.",type:"procedure"},
  ...
  { id:39,cat:"B",q:"Using come-alongs horizontally — what must be verified?",opts:["Load is painted","Only correct size","3+ workers present","Anchor capacity, pull direction, rated capacity"],ans:3,exp:"Verify anchor point capacity, straight-line pull (no side loading), and come-along rated capacity for the task.",type:"procedure"},
  ...
  { id:41,cat:"B",q:"What must be checked on chain slings before each use?",opts:["Color coding only","Master link only","Links for stretch, wear, gouges, cracks, twists","Hooks only"],ans:2,exp:"Inspect ALL links for elongation (>5%), wear, gouges, cracks, twists. Check hooks and master links for damage.",type:"procedure"},
  { id:42,cat:"B",q:"A shackle screw pin's primary purpose?",opts:["Decorative finish","Wear indicator","Limit sling angle","Securely close shackle body for load attachment"],ans:3,exp:"Screw pin closes the shackle for secure sling/cable attachment. Must be fully seated and tightened.",type:"recall"},

  // ═══ BLOCK C: Mechanical Power Transmission (32) ═══
  { id:43,cat:"C",q:"Most common cause of electric motor failure?",opts:["Bearing failure from improper lubrication","Shaft misalignment","Voltage fluctuation","Manufacturing defect"],ans:0,exp:"Bearing failure is #1 — usually from improper lubrication (too much/little/wrong type), contamination, or misalignment.",type:"recall"},
  ...
  { id:45,cat:"C",q:"Purpose of a flywheel on a prime mover?",opts:["Increase speed","Reduce startup vibration only","Store rotational energy, smooth power pulses","Connect to driven equipment"],ans:2,exp:"Flywheel stores kinetic energy between power strokes, smoothing pulsating torque for more constant speed output.",type:"recall"},
  { id:46,cat:"C",q:"Replacing an electric motor — which nameplate data must match?",opts:["Color and weight","Only horsepower","Brand only","HP, RPM, voltage, frame size, enclosure type"],ans:3,exp:"Match: HP, RPM, voltage, phase, frame size (mounting dims), enclosure (TEFC, ODP), and service factor.",type:"procedure"},
  { id:47,cat:"C",q:"Which prime mover converts fluid pressure to rotational energy?",opts:["Hydraulic motor","Electric motor","ICE engine","Air compressor"],ans:0,exp:"Hydraulic motor converts hydraulic pressure/flow into rotational mechanical energy.",type:"recall"},
  ...
  { id:49,cat:"C",q:"Fretting corrosion at bearing seat — likely cause?",opts:["Excessive speed","Over-lubrication","Loose fit between inner race and shaft","Shaft too hard"],ans:2,exp:"Fretting (reddish-brown oxidation) = micro-movement from too-loose fit. Fix with proper interference fit.",type:"critical"},
  { id:50,cat:"C",q:"What seal type prevents oil leakage along a rotating shaft?",opts:["O-ring","Gasket","Mechanical face seal","Lip seal (oil seal)"],ans:3,exp:"Lip seals with spring-loaded lip contact the shaft surface. For higher pressure, mechanical face seals are used.",type:"recall"},
  { id:51,cat:"C",q:"When removing a bearing with a puller, grip which part?",opts:["Inner race","Cage/retainer","Outer race","Rolling elements"],ans:0,exp:"Pull from the inner race — that's where the interference fit is. Pulling outer race or cage damages the bearing.",type:"procedure"},
  ...
  { id:53,cat:"C",q:"Shaft journal shows blue discoloration. Indicates?",opts:["Normal oxidation","Properly hardened","Overheating from insufficient lubrication","Chemical contamination"],ans:2,exp:"Blue = overheated (>500°F/260°C). Usually from lost lubrication. Metallurgy may be altered — shaft may need replacement.",type:"critical"},
  { id:54,cat:"C",q:"Which coupling compensates for angular, parallel, and axial misalignment?",opts:["Rigid coupling","Disc coupling","Gear coupling","Jaw (spider) coupling"],ans:3,exp:"Jaw couplings with elastomeric spider handle all three misalignment types plus vibration dampening.",type:"recall"},
  { id:55,cat:"C",q:"Clutch disc contaminated with oil — what happens?",opts:["Clutch slips, reduced torque transmission","Friction increases","No effect","Faster engagement"],ans:0,exp:"Oil reduces friction coefficient → slippage → can't transmit full torque. Replace disc, fix oil leak source.",type:"critical"},
  ...
  { id:57,cat:"C",q:"Purpose of a grid coupling?",opts:["Connect identical shafts only","Lock shafts permanently","Transmit torque, absorb shock, accommodate misalignment","Increase speed"],ans:2,exp:"Grid couplings use a tapered metallic grid spring that flexes to absorb shock and accommodate slight misalignment.",type:"recall"},
  { id:58,cat:"C",q:"How is roller chain slack measured?",opts:["Counting loose links","Pulling chain tight","Weighing the chain","Measuring deflection at mid-span"],ans:3,exp:"Measure sag at mid-span between sprockets. Proper slack = 2-4% of center distance for horizontal runs.",type:"procedure"},
  { id:59,cat:"C",q:"V-belt drive slipping — first action?",opts:["Check and adjust belt tension","Replace all belts","Increase motor speed","Add belt dressing"],ans:0,exp:"Check tension first — most common cause. Never use belt dressing (damages belts). If tension OK, check sheave/belt wear.",type:"procedure"},
  ...
  { id:61,cat:"C",q:"What causes chain 'stretch'?",opts:["Steel links elongate","Temperature expansion","Wear on pins and bushings","Improper lubrication only"],ans:2,exp:"'Stretch' = accumulated wear on pins/bushings at each joint, not steel elongation. Replace at 3% over nominal.",type:"recall"},
  { id:62,cat:"C",q:"What gear type transmits motion between perpendicular shafts?",opts:["Spur gears","Helical gears","Herringbone gears","Bevel gears"],ans:3,exp:"Bevel gears transmit power between intersecting shafts (typically 90°). Worm gears also work at 90° but don't intersect.",type:"recall"},
  { id:63,cat:"C",q:"Gear reducer: 1750 RPM input, 5:1 ratio. Output speed?",opts:["350 RPM","8750 RPM","1750 RPM","175 RPM"],ans:0,exp:"Output = Input ÷ Ratio = 1750 ÷ 5 = 350 RPM. Speed decreases, torque increases.",type:"critical"},
  ...
  { id:65,cat:"C",q:"After replacing gears, what must be checked?",opts:["New gear dimensions only","Oil level only","Backlash, tooth contact pattern, lubrication","Gear color match"],ans:2,exp:"Check backlash with feeler gauge/dial indicator, verify contact pattern with marking compound, ensure proper lube.",type:"procedure"},
  ...
  { id:68,cat:"C",q:"Two types of shaft misalignment?",opts:["Vertical and horizontal","Axial and radial","Linear and rotational","Angular and offset (parallel)"],ans:3,exp:"Angular (shafts at an angle) and offset/parallel (shafts parallel but not collinear). Most real cases combine both.",type:"recall"},
  { id:69,cat:"C",q:"Dial indicator: 0.010\" at 12 o'clock, 0.002\" at 6 o'clock. Offset?",opts:["0.004\"","0.010\"","0.012\"","0.008\""],ans:0,exp:"Offset = (Top – Bottom) ÷ 2 = (0.010 – 0.002) ÷ 2 = 0.004\". Divide TIR by 2 for actual centerline offset.",type:"critical"},
  ...
  { id:71,cat:"C",q:"What corrects soft foot during alignment?",opts:["Hammer","Level","Shims under machine feet","Torque wrench only"],ans:2,exp:"Precision shims under affected foot ensure all feet bear evenly. Soft foot distorts the frame, preventing accurate alignment.",type:"procedure"},
  { id:72,cat:"C",q:"Alignment shim calculation uses which variables?",opts:["Shaft diameter only","Dial reading only","Coupling diameter and torque","Gap, distance between supports, distance to correction"],ans:3,exp:"Shims = G × (A/B) where G = gap/offset, A = distance to correction, B = distance between measurement points.",type:"critical"},
  { id:73,cat:"C",q:"A fluid coupling showing excess heat and reduced efficiency needs:",opts:["Paint touch-up","Speed increase","Nothing, this is normal","Check fluid level, type, and internal wear"],ans:3,exp:"Check fluid level, verify correct fluid type, inspect for internal component wear. Normal operation = smooth, minimal heat.",type:"critical"},
  ...
  { id:75,cat:"D",q:"Before entering a robotic work cell for maintenance?",opts:["Full lockout/tagout, isolate all energy","Slow robot to min speed","Unplug teach pendant only","Inform operator"],ans:0,exp:"Full LOTO of all energy sources. Robots can move unexpectedly if not completely de-energized.",type:"procedure"},
  ...
  { id:77,cat:"D",q:"What determines airflow direction in a centrifugal fan?",opts:["Motor speed","Blade thickness","Scroll housing design","Shaft diameter"],ans:2,exp:"The scroll (volute) housing: air enters axially, is accelerated by impeller, discharged tangentially from scroll outlet.",type:"recall"},
  { id:78,cat:"D",q:"Replacing fan bearings — what must be checked?",opts:["Bearing size only","Lubrication type only","Motor amps only","Fit, shaft condition, housing bore, alignment"],ans:3,exp:"Check: bearing-to-shaft fit, shaft condition (no scoring), housing bore, seal condition, post-install alignment.",type:"procedure"},
  { id:79,cat:"D",q:"Axial fans are used when:",opts:["High volume at low pressure needed","High pressure needed","Air must be filtered","Hot gases must move"],ans:0,exp:"Axial fans = high volume, low pressure (ventilation/cooling). Centrifugal fans develop higher pressures for duct systems.",type:"recall"},
  ...
  { id:81,cat:"D",q:"Which pump type uses an impeller?",opts:["Gear pump","Diaphragm pump","Centrifugal pump","Piston pump"],ans:2,exp:"Centrifugal pumps use rotating impeller → velocity → volute converts to pressure. Others are positive displacement.",type:"recall"},
  { id:82,cat:"D",q:"How tight should pump packing be?",opts:["As tight as possible","Hand tight only","No adjustment needed","Allow slight drip for cooling/lubrication"],ans:3,exp:"Must drip slightly (few drops/min) for cooling and lubrication. Over-tight = burned packing, scored sleeve.",type:"procedure"},
  { id:83,cat:"D",q:"Positive displacement pumps deliver:",opts:["Constant flow per revolution","Variable flow","Constant pressure","Variable pressure"],ans:0,exp:"PD pumps deliver fixed volume per revolution regardless of discharge pressure. That's why they need pressure relief protection.",type:"recall"},
  ...
  { id:85,cat:"D",q:"Excessive discharge temp in reciprocating compressor — causes?",opts:["Oversized motor","Inlet filter too clean","Worn rings, broken valves, insufficient cooling","Tank too large"],ans:2,exp:"Worn piston rings (recirculation), broken valves, fouled cooler, low oil. Can cause oil ignition from carbon buildup.",type:"critical"},
  { id:86,cat:"D",q:"Purpose of aftercooler on compressed air system?",opts:["Increase pressure","Filter air","Regulate flow","Cool air and remove moisture"],ans:3,exp:"Reduces compressed air temp → water condenses out → separator removes liquid. Protects downstream equipment from moisture.",type:"recall"},
  { id:87,cat:"D",q:"Screw compressor oil separator — excessive carryover. Check?",opts:["Separator element condition and oil level","Motor bearings","Inlet filter only","Discharge piping"],ans:0,exp:"Check: element (clogged/damaged), oil level, minimum pressure valve, oil return line for blockage.",type:"procedure"},
  ...
  { id:89,cat:"D",q:"Two-stage reciprocating compressor — purpose of intercooler?",opts:["Increase HP","Filter contaminants","Cool air between stages, improve efficiency","Reduce noise"],ans:2,exp:"Intercooler cools air between stages. Cooler = denser = less work to compress further. Improves efficiency, reduces discharge temp.",type:"recall"},
  { id:90,cat:"D",q:"Pipe schedule number indicates:",opts:["Pipe length","Outside diameter","Thread count","Wall thickness"],ans:3,exp:"Schedule (40, 80, etc.) = wall thickness for given nominal size. Higher schedule = thicker = higher pressure rating.",type:"recall"},
  { id:91,cat:"D",q:"Purpose of expansion joint in piping?",opts:["Absorb thermal expansion/contraction","Filter contaminants","Increase pressure","Change flow direction"],ans:0,exp:"Absorbs thermal growth, vibration, movement. Without them, thermal forces damage supports, flanges, equipment.",type:"recall"},
  ...
  { id:93,cat:"D",q:"Conveyor belt tracking to one side — likely cause?",opts:["Belt too long","Load too heavy","Uneven tension or misaligned idlers","Motor too fast"],ans:2,exp:"Mistracking: unequal tension, misaligned idlers, worn crowned pulleys, uneven loading, or frame distortion.",type:"critical"},
  { id:94,cat:"D",q:"Purpose of a belt scraper (cleaner) on conveyor?",opts:["Increase speed","Increase friction","Align the belt","Remove carryback from return side"],ans:3,exp:"Removes residual material (carryback) to prevent buildup on return idlers, mistracking, and cleanup issues.",type:"recall"},
  { id:95,cat:"D",q:"Screw conveyor vibrating with grinding noise — inspect:",opts:["Flights, trough wear, hanger bearings","Motor nameplate","Drive belt only","Discharge opening only"],ans:0,exp:"Check: worn flights contacting trough, worn liner, seized hanger bearings, bent screw sections, foreign objects.",type:"procedure"},
  ...
  { id:97,cat:"D",q:"Conveyor belt tensioning — adjustment made at:",opts:["Head pulley","Belt midpoint","Tail pulley or take-up device","Nearest idler"],ans:2,exp:"Tension at tail pulley (screw take-up) or gravity take-up. Allows tension and tracking adjustment. Head pulleys are fixed.",type:"procedure"},
  { id:98,cat:"D",q:"Installing flanged pipe gasket — use as lubricant:",opts:["Motor oil","WD-40","Silicone spray","Compatible anti-seize compound"],ans:3,exp:"Use anti-seize/gasket compound compatible with process fluid, temperature, and pressure. Wrong lube attacks gasket or contaminates process.",type:"procedure"},

  // ═══ BLOCK E: Fluid Power Systems (21) ═══
  { id:99,cat:"E",q:"Hydraulic force formula?",opts:["Force = Pressure × Area","Force = Flow × Speed","Force = Volume ÷ Time","Force = Pressure ÷ Area"],ans:0,exp:"F = P × A. Fundamental hydraulic formula. Area = piston area (π × r²). On the Red Seal exam.",type:"recall"},
  ...
  { id:101,cat:"E",q:"Purpose of hydraulic accumulator?",opts:["Filter oil","Increase pump speed","Store pressurized fluid for peaks, absorb shock","Cool oil"],ans:2,exp:"Stores energy for peak demands, absorbs shock, maintains pressure, compensates for leakage.",type:"recall"},
  { id:102,cat:"E",q:"Hydraulic cylinder drifting under load — cause?",opts:["Pump worn","Oil too cold","Reservoir too large","Internal seal leakage past piston"],ans:3,exp:"Internal leakage past piston seals lets oil bypass. External rod seal leaks cause fluid loss, not drift.",type:"critical"},
  { id:103,cat:"E",q:"Flow control valve regulates:",opts:["Actuator speed","System pressure","Fluid temperature","Pump RPM"],ans:0,exp:"Flow control = flow rate to actuators = speed. Relief valves control pressure. Flow = speed; Pressure = force.",type:"recall"},
  ...
  { id:105,cat:"E",q:"Which valve controls direction of fluid to actuators?",opts:["Relief valve","Flow control","Directional control valve","Sequence valve"],ans:2,exp:"DCVs direct flow to/from actuators — determining cylinder extend/retract or motor rotation direction.",type:"recall"},
  { id:106,cat:"E",q:"Noisy pump + foamy reservoir oil — cause?",opts:["Oil too thick","Pump too slow","Filter too restrictive","Air entering suction line (aeration)"],ans:3,exp:"Foamy oil + noise = air intrusion. Causes: low oil, suction leak, damaged shaft seal, return line above oil level. Destroys pump rapidly.",type:"critical"},
  ...
  { id:109,cat:"E",q:"When changing hydraulic filters — prevent contamination by:",opts:["Work fast","Wipe with rag","Clean area, pre-fill new filter, minimize open time","Only change when hot"],ans:2,exp:"Clean housing, pre-fill filter with clean fluid, minimize open time, use lint-free materials. Contamination = #1 system killer.",type:"procedure"},
  { id:110,cat:"E",q:"Most common cause of hydraulic system failure?",opts:["Pump defects","Electrical issues","Cylinder rod damage","Fluid contamination (dirt, water, air)"],ans:3,exp:"70-80% of failures from contamination. Proper filtration, clean fill procedures, and oil analysis are essential.",type:"recall"},
  { id:111,cat:"E",q:"Standard operating pressure for industrial pneumatic systems?",opts:["80-100 PSI (550-690 kPa)","200 PSI","30-40 PSI","150-175 PSI"],ans:0,exp:"Most industrial pneumatics: 80-100 PSI. Higher pressures increase energy costs without proportional benefit.",type:"recall"},
  ...
  { id:113,cat:"E",q:"Pneumatic cylinder moving slowly — check:",opts:["Bore size","Paint condition","Flow control, supply pressure, exhaust restrictions","Rod thread size"],ans:2,exp:"Check flow controls, supply pressure, exhaust restrictions, internal seal wear, undersized supply lines.",type:"procedure"},
  { id:114,cat:"E",q:"Danger of non-rated components in compressed air systems?",opts:["Reduced air quality","Increased noise only","Slight efficiency loss","Catastrophic burst failure under pressure"],ans:3,exp:"Non-rated components can burst catastrophically. All pneumatic components must be rated for system max pressure.",type:"recall"},
  { id:115,cat:"E",q:"Vacuum system losing suction — inspect:",opts:["All connections for leaks, filter, pump wear","Motor speed only","Reservoir only","Gauge color"],ans:0,exp:"Check: fittings/hoses/gaskets for leaks, filter/strainer blockage, vacuum pump wear (vanes, seals), check valve function.",type:"procedure"},
  ...
  { id:117,cat:"E",q:"Why is water removal critical in pneumatics?",opts:["Increases pressure","No effect","Causes corrosion, washes lubrication, freezes","Only affects reservoir"],ans:2,exp:"Water: corrodes internals, washes away lube films, freezes in exhaust ports (valve failure), reduces equipment efficiency.",type:"recall"},
  { id:118,cat:"E",q:"Pneumatic valve actuated by electrical signal?",opts:["Manual valve","Pilot-operated check","Needle valve","Solenoid valve"],ans:3,exp:"Solenoid valves use electromagnetic coil to shift spool, directing air flow. Enables PLC/automated control.",type:"recall"},
  { id:119,cat:"E",q:"Hissing from a pneumatic cylinder indicates:",opts:["Normal operation","Excessive pressure","Air leak from seals, fittings, or connections","Proper lubrication"],ans:2,exp:"Hissing = air leak. Check piston/rod seals, fittings, connections. Use soapy water on external joints to locate.",type:"critical"},
  ...
  { id:121,cat:"F",q:"Vibration at 1× RPM with high amplitude indicates:",opts:["Imbalance","Bearing defect","Misalignment","Looseness"],ans:0,exp:"Dominant 1× RPM = mass imbalance. Misalignment shows 2× RPM. Bearings show at specific bearing frequencies.",type:"critical"},
  { id:122,cat:"F",q:"Infrared thermography in electrical systems detects:",opts:["Voltage levels","Wire color","Hot spots from loose connections, overloads, failing parts","Current direction"],ans:2,exp:"Detects abnormal heat from loose connections (high resistance), overloaded conductors, failing breakers — before failure or fire.",type:"recall"},
  { id:123,cat:"F",q:"Oil analysis reveals:",opts:["Oil color only","Viscosity only","Temperature only","Wear metals, contamination, oil degradation"],ans:3,exp:"Identifies: wear metals (Fe, Cu, Pb = component wear), contaminants (dirt, water), oil condition (viscosity, oxidation, additives).",type:"recall"},
  ...
  { id:125,cat:"F",q:"Over-greasing a bearing causes:",opts:["Excessive heat, premature failure from churning","Better protection","No negative effect","Improved speed"],ans:0,exp:"Elements churn excess grease → heat → friction → grease breakdown → blown seals. Follow 1/3 fill rule.",type:"recall"},
  { id:126,cat:"F",q:"Ultrasonic testing in predictive maintenance detects:",opts:["Temperature","Shaft speed","Early bearing wear, leaks, electrical discharge","Alignment"],ans:2,exp:"Detects: early bearing wear (before vibration can), air/gas/vacuum leaks, steam trap issues, electrical arcing/corona.",type:"recall"},
  { id:127,cat:"F",q:"A CMMS is used for:",opts:["Tracking parts only","Sending emails only","Recording downtime only","PM scheduling, work orders, inventory, analysis"],ans:3,exp:"CMMS manages: PM scheduling, work orders, spare parts, equipment history, labor tracking, maintenance cost analysis.",type:"recall"},
  ...
  { id:129,cat:"F",q:"Vibration pattern indicating mechanical looseness:",opts:["Multiple harmonics (1×, 2×, 3×, 4×...)","Single 1× peak","Random broadband only","Single high-frequency peak"],ans:0,exp:"Looseness generates multiple harmonics and sub-harmonics. Creates 'picket fence' appearance in spectrum.",type:"critical"},
  { id:130,cat:"F",q:"Thermal expansion formula (on Red Seal exam):",opts:["Temp × Mass","Pressure × Volume","ΔT × Length × Coefficient of expansion","Heat × Density"],ans:2,exp:"Expansion = ΔT × L × α. Each material has its own coefficient. Critical for piping, shafts, machine bases.",type:"recall"},
  { id:131,cat:"F",q:"During commissioning, verify before startup:",opts:["Power connected only","Paint finish only","Nameplate only","Alignment, lubrication, rotation, safety devices, connections"],ans:3,exp:"Checklist: alignment, fluids filled, rotation direction (bump test), guards, safety devices, connections tight, follow manufacturer procedure.",type:"procedure"},
  ...
  { id:133,cat:"F",q:"Newly installed pump vibrates excessively — check first:",opts:["Alignment, foundation bolts, piping strain, rotation","Model number","Flow rate only","Paint"],ans:0,exp:"First: shaft alignment (most common cause), foundation bolts, piping strain (forces on flanges), rotation direction, priming.",type:"procedure"},
  { id:134,cat:"F",q:"Documentation to update after commissioning:",opts:["Nothing","Purchase order only","Equipment records, PM schedules, parts lists, as-built drawings","Warranty card only"],ans:2,exp:"Update: equipment register, PM schedules in CMMS, spare parts, as-built drawings, alignment records, baseline readings.",type:"procedure"},
  { id:135,cat:"F",q:"'Bump test' during commissioning verifies:",opts:["Load capacity","Structural integrity","Paint adhesion","Correct rotation direction of motors/pumps"],ans:3,exp:"Briefly energizes motor to check rotation before full speed. Wrong rotation destroys pumps, fans, compressors instantly.",type:"procedure"},
];
      ...
      <div style={{ ...wrap, padding: "40px 20px" }} id="pricing">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 16 }}>
          ...
          <div style={{ background: `linear-gradient(135deg, rgba(255,107,53,0.08), rgba(255,167,38,0.04))`, border: `2px solid ${T.accent}`, borderRadius: 16, padding: 28, position: "relative" }}>
            ...
            <div style={{ fontSize: 13, color: T.text2, marginBottom: 20 }}>Everything you need to pass</div>
